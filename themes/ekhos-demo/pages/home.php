...
<section class="section section-home" id="hero">
    <div class="hero_container">
        ...
        <p>Ceci est une page de présentation de notre plug-in IdSound. À partir de cette page, vous pourrez constater le storyboard mis en place mettant en avant l’univers que vous souhaitez présenter à vos clients.</p>

        <p>Ne soyez plus spectateur, soyez l’acteur !</p>
    </div>
    <div class="hero_background">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home_hero_background.png" alt="background">
    </div>
</section>
...
<section class="section section-home" id="product">
    <div class="product_container">
        <div class="product_text">
            ...
            <p>C’est ici que tout commence ! Depuis un storyboard et votre storytelling, créer votre histoire pour mettre en avant votre produit. Votre son et votre voix vous accompagnera tous le long de votre aventure !</p>
        </div>
...
<section class="section section-home" id="story">
    <div class="story_container">
        ...
        <div class="story_visual">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home_story_image.png" alt="visual">
        </div>
    </div>
</section>
